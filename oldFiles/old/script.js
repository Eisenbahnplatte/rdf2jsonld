...
async function readInData(){
    ...
    // var data = httpGet('http://de.dbpedia.org/resource/Ost-Berlin')
    ...
    var nquads = $rdf.serialize(store, store, null, 'application/n-quads')
    
    convertToJsonLD(nquads)
}
...
// const nquads = '<http://example.org/#spiderman> <http://www.perceive.net/schemas/relationship/enemyOf> <http://example.org/#green-goblin> <http://example.org/graphs/spiderman> .'
async function convertToJsonLD(nquads){
